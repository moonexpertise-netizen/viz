  ...
  useEffect(() => {
    const fetchEntries = async () => {
      try {
        ...
        let res;
        if (clientId) {
          res = await reportAPI.getClientEntries(clientId, accountNumber, from || undefined, to || undefined);
        } else {
          res = await reportAPI.getEntries(balanceId, accountNumber, from || undefined, to || undefined);
        }
